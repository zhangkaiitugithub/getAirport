#!MANAGED-CONFIG https://www.iacgbt.com/link/Ip3ph1bQqKi9vt8f?clash=1

#---------------------------------------------------#
## 上次更新于：2022-10-20 12:37:17
#---------------------------------------------------#
...
proxies:
  -
    ...
    port: 26010
    password: cb34caac-e28b-3609-9714-4326df39f99a
    sni: a1.iacgbt.com
  -
    name: '🇭🇰  香港 | 103 | 原生IP | 1x'
    type: vmess
    ...
    port: 31002
    uuid: cb34caac-e28b-3609-9714-4326df39f99a
    alterId: 0
    cipher: auto
    udp: true
  -
