#!MANAGED-CONFIG https://www.iacgbt.com/link/J1A85ihNMl9RuxMw?clash=1

#---------------------------------------------------#
## 上次更新于：2022-09-17 11:02:10
#---------------------------------------------------#
...
proxies:
  -
    ...
    port: 26010
    password: 962fded4-206f-3bc8-b585-16c40175b8b3
    sni: a1.iacgbt.com
  -
  ...
  -
    ...
    port: 34567
    uuid: 962fded4-206f-3bc8-b585-16c40175b8b3
    alterId: 0
    cipher: auto
    udp: true
    servername: sg1.bfstec.com
    network: ws
    ws-path: /123abc
    ws-headers:
      Host: sg1.bfstec.com
